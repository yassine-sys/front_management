...
onSubmit() {
  if (this.form.valid) {
    ...
    if (this.group.gId === 0) {
      // If group ID is 0, it means that the group is new and we need to add it to the database
      ...
      // If group ID is not 0, it means that the group already exists and we need to update it in the database
